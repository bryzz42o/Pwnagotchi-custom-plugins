...
class WiFiHoneypot(plugins.Plugin):
    ...
    __version__ = '1.0.0'
    __license__ = 'GPL3'
    __description__ = 'Sets up a Wi-Fi honeypot to attract potential attackers.'
    ...
    def create_beacon(self, ssid, password_protected=False):
        dot11 = Dot11(type=0,
                      subtype=8,
    ...
    def on_ui_setup(self, ui):
        with ui._lock:
            ui.add_element('honeypot_status', LabeledValue(color=BLACK, label='HP', value='Inactive',
